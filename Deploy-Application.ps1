...
Try {
	...
	[string]$appVersion = '18 Registration'
	[string]$appArch = 'x86'
	[string]$appLang = 'EN'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		Copy-File -Path "$dirSupportFiles\license.ini" -Destination "$ProgramData\minitab\license.ini"
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Execute-MSI -Action 'Uninstall' -Path '{8D24BFA4-1266-436F-9EBF-F83F5CFADD2E}' -Parameters "/qn"
